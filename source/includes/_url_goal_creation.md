...
> Quick example: Create a goal to do 5 pushups per day
...
* [Goal Creation API Endpoint](#creategoal) - For programmatic goal creation via POST request
* [Goal Types Reference](#goal-types) - Detailed information about goal types and their attributes
