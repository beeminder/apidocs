---
title: URL-Based Goal Creation
---

```plaintext title="Quick example: Create a goal to do 5 pushups per day"
...
<aside class="notice">
Users must be logged in to create goals. Unauthenticated requests will redirect to the login page.
</aside>
...
Reduce inbox from 200 emails:
```
https://www.beeminder.com/new?goaltype=whittledown&units=emails&start_value=200&goalname=inbox
```
...
* [Goal Creation API Endpoint](/goal/#creategoal) - For programmatic goal creation via POST request
* [Goal Types Reference](/goal/#goal-types) - Detailed information about goal types and their attributes
